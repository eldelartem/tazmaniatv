...
Base = 'http://mynewtazmania.blogspot.com/p/addon-tazmaniatv.html' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.tazmaniatv') #    modificar("el nombre de tu addons")
